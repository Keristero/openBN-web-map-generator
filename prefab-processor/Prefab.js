...
let tiled_tileTypes = {
    ...
    "forward-stairs": {
        subIndex: {
            0: { type: "Tile", name: "Forward-Middle-Left", id: 7, Direction: "Up Left" },
            1: { type: "Tile", name: "Forward-Middle-Right", id: 8, Direction: "Up Right" },
            2: { type: "Tile", name: "Forward-Top-Left", id: 9, Direction: "Up Left" },
            3: { type: "Tile", name: "Forward-Top-Right", id: 10, Direction: "Up Right" },
        }
    },
    "back-stairs": {
        subIndex: {
