...
/**
 * tile_tileTypes is a mapping between tiles as found in the prefabs to tiles generated by the map generator
 * the keys in the root level indicate the name of the .tsx file that the mapping applies to
 * the subIndex refers to the tile index relative to the first GID for that tileset
 * type = Tile indicates that this tile will generate on a ground layer
 *      id = id that this tile will have during the map generation stage
 * type = Feature indicates that this should be on the object layer
 *      collection = the kind of features that can appear in place of this feature
 *      Direction = features generated at this spot will inherit this direction
